...
const Details = () => {
  return (
    ...
    <h4 className='name'>Jill Anderson</h4>
    <h6 className='ui'>Python Developer&nbsp;<i class="fa-brands fa-python fa-lg" style={{color: `#FFD43B`}}></i>&nbsp;</h6>
    ...
    <div>
                       ...
                       <div >
                             ...
                             <p id='experience-years2'>2021 To 2024</p>
                                         ...
                                         <div >
                                      <img  className='tm' src={ tm }/>
                                      <div className="line1"></div>
                                      <img  className='wip' src={ wipro }/>
                          <div >
