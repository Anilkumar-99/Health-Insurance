...
const Details1 = () => {
  return (
    ...
    <h4 className='name'>Jill</h4>
    <h6 className='ui'>Python FullStack &nbsp;<i class="fa-brands fa-python fa-lg" style={{color: `#FFD43B`}}></i>&nbsp;</h6>
    ...
    <div>
                       ...
                       <div className='cir-container'>
                           <div id="cir1"><img className='tcs' src={ TCS }alt='tcs'/></div>
                           <div className="line"></div>
                          <div id="cir2"><img className='hcl' src={ hcl }alt='hcl'/></div>
                       ...
                       <div >
                             ...
                             <p id='experience-years2'>2021 To 2024</p>
                                      ...
                                      <img  className='wip' src={ wipro } alt='wipro'/>
                          <div >
