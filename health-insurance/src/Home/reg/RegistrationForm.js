...
import { Grid, TextField, Button, Radio,Box, RadioGroup, FormControlLabel, FormControl, FormLabel } from "@mui/material";
...
function RegistrationForm() {
  ...
  const emailregex = /^(?!.?\.\.)(?!.?\.(|\.|\.))([a-zA-Z0-9]+[a-zA-Z]*)(?:[.][a-zA-Z0-9]+)?(?:[.]?[a-zA-Z0-9]+)?@[a-zA-Z.]+(?:[a-zA-Z0-9]+)?\.[a-zA-Z]{2,3}$/;
  ...
  const handleBlur = async () => {
    try {
      const response = await fetch(
        `http://192.168.1.2:9098/register/CheckMail/${values.email}`,
        {
          method: "POST",
          headers: {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      axios
        .post("http://192.168.1.2:9098/register/addregister", values)
        .then((response) => {
      ...
      toast.error("Please verify Email and Mobile");
    }
  }
    ...
    <div>
      ...
      <div className='con'>
        ...
        <div className="d-flex justify-content-between align-items-center">
           <h1 className='text-primary text-center mb-4 rf'>Registration Form <i className="fa-solid fa-right-to-bracket fa-fade fa-2xs"></i></h1>
          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={12} className="d-flex">
              ...
              <BootstrapButton
                ...
                onClick={EmailOtp}
                style={{ marginTop: "1px", width: "30%",height:"35px",marginLeft:"10px"}}
                disabled={!emailregex.test(values.email) || !isEmailValid}
              >
                Verify email
              </BootstrapButton> 
              )}
              {isEmailOtpVerified && (
                <div className="verified">
                  {/* <FaCheck /> */}
                  <span className="verified-text"><i className="fa-solid fa-circle-check text-success mx-3 mt-3"></i></span>
                </div>
              )}
            </Grid>
            ...
            <Grid item xs={12}>
              ...
              <Button
                ...
                color="primary"
                fullWidth
                className="sp-submit-button px-5 py-2"
              >
                Register
              </Button>
              </div>
        ...
        <Modal show={showOtpModal} onHide={() => setShowOtpModal(false)}>
          <Modal.Header closeButton>
            <Modal.Title className="fw-bold font">Enter OTP</Modal.Title>
          </Modal.Header>
          <Modal.Body>
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title className="fw-bold font">Enter Email OTP</Modal.Title>
          </Modal.Header>
          <Modal.Body>
