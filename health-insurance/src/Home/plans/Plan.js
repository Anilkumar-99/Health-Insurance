...
const Plan = () => {
    ...
    useEffect(() => {
        if (selectedPlan !== 0) {
            ...
            setSelectedPremium(premiums[selectedPlan]);
        }
    }, [coverage, selectedPlan]);
    ...
    const handleProceed = (e) => {
        if (selectedPlan === 0) {
            setErrorMessage("Please select your plan");
            return;
        }
    ...
    return (
        <div>
            ...
            <h1 className="light mt-2"><i class="animation"></i>Quotation&nbsp; Details<i class="animation"></i></h1>
            ...
            <div className='plancard mt-5 mx-2'>
                <h2 className="light"><i class="animation"></i>Choose Your Plan<i class="animation"></i></h2>
                <div className='year'>
                <button
                        type="button"
                        className={`btn btn-outline-primary mt-5 ${selectedPlan === 1 ? 'active' : ''}`}
                    ...
                    <button
                        type="button"
                        className={`btn btn-outline-secondary mt-5 ${selectedPlan === 2 ? 'active' : ''}`}
                    ...
                    <button
                        type="button"
                        className={`btn btn-outline-success mt-5 ${selectedPlan === 3 ? 'active' : ''}`}
                    ...
                    <button
                        type="button"
                        className={`btn btn-outline-danger mt-5 ${selectedPlan === 4 ? 'active' : ''}`}
                    ...
                    <button
                        type="button"
                        className={`btn btn-outline-warning mt-5 ${selectedPlan === 5 ? 'active' : ''}`}
